...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Bubbly Friends',
    description: '',
    url: 'https://klavs.lv/games/bubblyFriends',
    siteName: 'Klāvs Kalniņš Portfolio',
    images: [
      {
        url: 'https://klavs.lv/bubblyFriends/card_line_art.svg',
        width: 1200,
        height: 630,
        alt: 'Bubbly Friends Preview',
      },
    ],
    type: 'website',
  },
  alternates: {
    canonical: 'https://klavs.lv/games/bubblyFriends',
  },
  robots: {
    index: true,
    follow: true,
...
export default function Game() {
  return (
    <main className="relative min-h-screen flex flex-col items-center justify-center bg-[#063636] overflow-hidden">
      {/* Background Line Art */}
      <div className="absolute inset-0 bg-[url('/bubblyFriends/line_art.svg')] bg-cover bg-center opacity-10 z-0" />
      ...
      <div className="h-20 flex justify-center items-center z-10">
        <h1 className="text-4xl font-bold text-white/70 z-10">Bubbly Friends</h1>
      </div>
      ...
      >
        ...
        <Link
          href="https://testflight.apple.com/join/jySN9QPc"
          className="p-6 bg-white/10 backdrop-blur-md rounded-lg shadow-lg border border-white/10 hover:bg-white/20 transition-colors flex justify-center items-center w-full"
        >
      ...
      <div className="mt-20 w-full max-w-4xl z-10" style={{
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Link
            href="/games/bubblyFriends/policy"
          ...
          <Link
            href="/games/bubblyFriends/TermsOfService"
            className="p-6 bg-white/10 backdrop-blur-md rounded-lg shadow-lg border border-white/10 hover:bg-white/20 transition-colors"
          >
