...
export default function Privacy() {
  return (
    <div>
      ...
      <p>
        Klavs built the Donut Game! app as a Free app. This SERVICE is provided
        by Klavs at no cost and is intended for use as is.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which are accessible at Donut Game! unless
      ...
      <p>This policy is effective as of 2023-11-25</p>{" "}
      <p>
        <strong>Contact Us</strong>
      </p>{" "}
      <p>
        If you have any questions or suggestions about my Privacy Policy, do not
        hesitate to contact me at klavskalninss@gmail.com.
      </p>{" "}
      <p>
