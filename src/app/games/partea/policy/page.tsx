  ...
  return (
    <main className="flex min-h-screen flex-col items-center gap-2 p-4">
      ...
      <div className="max-w-2xl space-y-4">
        <p>
          Klāvs Kalniņš built the Partea game as a Freemium game. This SERVICE is provided by
          Klāvs Kalniņš at no cost and is intended for use as is.
        </p>
        <p>
        ...
        <p>
          ...
          Conditions, which is accessible at Partea unless otherwise defined in this Privacy Policy.
        </p>
        <h3 className="text-xl font-bold mt-6 mb-2">Information Collection and Use</h3>
        <p>
